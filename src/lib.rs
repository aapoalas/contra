...
impl<'a> Handle<'a> {
    pub fn new(arena: &mut Arena, value: f64, _gc: NoGc<'a>) -> Handle<'a> {
...
#[derive(Debug)]
pub struct Gc<'a>(Contravariant<'a>);
...
#[cfg(test)]
mod tests {
    use crate::{Arena, Contravariant, Gc, Handle};
